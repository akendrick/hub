...
.todo-subhdr-t{font-size:12px;font-weight:800;letter-spacing:.05em;text-transform:uppercase}
.todo-subhdr-n{font-size:11px;color:#888}
.todo-body{flex:1;overflow:hidden;display:flex;flex-direction:column}
.sec-hdr{background:#111;color:#fff;font-size:11px;font-weight:800;text-transform:uppercase;letter-spacing:.1em;padding:3px 8px;flex-shrink:0}
.item{padding:5px 8px;border-bottom:1px solid #eee;display:flex;flex-direction:column;justify-content:center;flex-shrink:0}
.item.z{background:#f5f5f5}
.item-t{font-size:17px;font-weight:600;line-height:1.2;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
.item-m{font-size:11px;color:#999;margin-top:2px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
.empty{font-size:14px;color:#ccc;font-style:italic;padding:12px 8px}
.more{font-size:11px;color:#bbb;padding:3px 8px;flex-shrink:0;font-style:italic}
</style>

<div class="hdr">
  <div class="hdr-t">Go &middot; DGS</div>
  <div>
    {% if go_opponent != "" %}
